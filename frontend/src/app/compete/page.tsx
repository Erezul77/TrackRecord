              ...
              <button
                onClick={async () => {
                  ...
                  try {
                    ...
                    setMessage({ type: 'error', text: 'Facebook login not available' })
                  }
                  setLoading(false)
                }}
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 bg-[#1877F2] text-white font-bold py-3 hover:bg-[#166FE5] disabled:opacity-50 transition-colors"
              >
